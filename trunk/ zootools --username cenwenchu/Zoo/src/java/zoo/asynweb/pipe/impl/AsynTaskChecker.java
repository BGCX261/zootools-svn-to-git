 ...
 *
 */
public class AsynTaskChecker <I extends WebPipeInput, R extends WebPipeResult,
											D extends WebPipeData<I,R>> extends Thread
{
	...
	public AsynTaskChecker(AbstractWebPipeManager<I,R,D> webPipeManager
		...
		while(flag)
		{
			...
			if (data != null)
			{
				if (data.getPipeResult().isDone())
					_threadPool.execute(new WebPipeTask<I,R,D>(data,null,webPipeManager,false));
				else
